...
public class Analyze {
  ...
  /*  *//**
    ...
    public String analyzePatterns(@PathVariable("token") String token,
        ...
        List<List<PatternRecogStat_old>> results = new FileAccess().getPatternRecogResults(taskToken);

        // create task object and upload task results to DB (as DynamoDB chunks)
        PatternRecogTask_old task = new PatternRecogTask_old(taskToken, new Date(), keyArr[keyArr.length-1], s3Status.getFileSize(),
    ...
    *//**
    ...
    public ReAnalyzeResult reanalyzePatternRecognition(@PathVariable(value="token") String token,
                                                                    ...
                                                                    @RequestParam("minMembersPerCluster") int minMembersPerCluster) {
        // validation
        PatternRecogTask_old task = dao.getPatternRecogTask(token);
        ...
        List<List<PatternRecogStat_old>> results = new FileAccess().getPatternRecogResults(token);
        int numChunks = dao.saveTaskResults(task, results);
    ...
    class ReAnalyzeResult {
        public List<List<PatternRecogStat_old>> results;
    ...
    public String analyzePattern(@PathVariable("token") String token,
        ...
        PatternRecognitionTask currentTask = new PatternRecognitionTask(taskToken, new Date(), keyArr[keyArr.length-1],
